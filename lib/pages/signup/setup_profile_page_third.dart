...
class SetupProfilePageThird extends StatefulWidget {
  const SetupProfilePageThird({super.key});

  @override
  State<SetupProfilePageThird> createState() => _SetupProfilePageThirdState();
}

class _SetupProfilePageThirdState extends State<SetupProfilePageThird> {
  // Section 1
